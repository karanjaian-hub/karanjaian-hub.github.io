...
/* ============================================================
   SCROLL REVEAL
   Desktop only — CSS hides elements via min-width:769px
   Mobile — elements always visible
   ============================================================ */
function initReveal() {
...
function initNav() {
  ...
  if (!nav) return;
  const update = () => nav.classList.toggle('stuck', window.scrollY > 60);
  update();
...
function initMobileMenu() {
  ...
  document.addEventListener('click', e => {
    if (open && !menu.contains(e.target) && !burger.contains(e.target)) close();
  });
...
function initParticles() {
  ...
  class Particle {
    ...
    draw() {
      ...
      ctx.fillStyle = `rgba(204,255,0,${this.a})`;
      ctx.fill();
    }
  }
...
/* ============================================================
   PROJECT CARD SCROLL REVEAL (after render)
   ============================================================ */
